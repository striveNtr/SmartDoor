...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(GPIOD, &GPIO_InitStructure);	  //初始化PA0,1
 	GPIO_SetBits(GPIOD,GPIO_Pin_0|GPIO_Pin_1);
	
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_3|GPIO_Pin_4;	 
// 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING; 		 //推挽输出
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
// 	GPIO_Init(GPIOA, &GPIO_InitStructure);	  //初始化PA0,1
//// 	GPIO_SetBits(GPIOA,GPIO_Pin_5);
	
//	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_7;	 
...
// //	GPIO_SetBits(GPIOA,GPIO_Pin_15|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_8|GPIO_Pin_9);
